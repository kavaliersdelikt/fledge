...
export default function InstallPage(){
 const [ref,setRef]=useState('main'),[platform,setPlatform]=useState<Platform>('windows'),[copied,setCopied]=useState(false);
